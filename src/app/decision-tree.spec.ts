...
describe('DecisionTree', () => {
  ...
  it('should work...', () => {
    ...
    let leaf = TreeScaler.bisectRight(tree2);
    let relativeAddress: number[] = [leaf.address[leaf.address.length-1]];
    let parentAddress: number[] = leaf.address.slice(0,leaf.address.length-1);
